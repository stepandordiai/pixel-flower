...
const guests = [
	...
	{ slug: "grandma-and-grandpa", name: "Дорога Бабуся та Дідусь" },
	{ slug: "family-kopylets", name: "Дорога сім'я Копилець" },
	{ slug: "family-tokar", name: "Дорога сім'я Токар" },
	{ slug: "family-megalkovich", name: "Дорога сім'я Мигалкович" },
	{ slug: "family-chonka", name: "Дорога сім'я Чонка" },
	{ slug: "family-shafar", name: "Дорога сім'я Шафар" },
	{ slug: "family-zizen", name: "Дорога сім'я Зизень" },
	{ slug: "family-roshkanuk", name: "Дорога сім'я Рошканюк" },
	{ slug: "family-karasovi", name: "Дорога сім'я Карасьові" },
	{ slug: "family-bentsa", name: "Дорога сім'я Бенца" },
	{ slug: "family-tsirik", name: "Дорога сім'я Цірик" },
	{ slug: "family-novakovi", name: "Дорога сім'я Новакові" },
	{ slug: "artem", name: "Дорогий Артем" },
	{ slug: "maksym", name: "Дорогий Максим" },
	{ slug: "stepan-and-andriana", name: "Дорогі Степан та Андріана" },
	{ slug: "ivan-and-tetana", name: "Дорогі Іван та Тетяна" },
	{ slug: "vasyl-and-tetana", name: "Дорогі Василь та Тетяна" },
	{ slug: "ivan-and-darina", name: "Дорогі Іван та Дарина" },
	{ slug: "angelina", name: "Дорога Ангеліна" },
	{ slug: "bogdana", name: "Дорога Богдана" },
	{ slug: "ivan", name: "Дорогий Іван" },
	{ slug: "andriy-and-nadia", name: "Дорогі Андрій та Надія" },
	{ slug: "darina-and-denis", name: "Дорогі Дарина та Денис" },
	{ slug: "family-kuchar", name: "Дорога сім'я Кухар" },
];
...
export default function Wedding4Client() {
			...
			>
				<div style={{ display: "flex", flexDirection: "column" }}>
					<section className={styles.hero}>
						...
						{/* <p style={{ fontSize: "1.5rem", fontWeight: 700 }}>Save the Date</p> */}
						<p
					...
					<img
						...
						alt=""
					/>
					<section style={{ marginTop: "50px" }} className={styles.section}>
						<p className={`${styles["section__title"]} ${styles.animate}`}>
							{guest ? `${guest.name}` : "Дорогі гості"}
						</p>

						<p className={`${styles.txt} ${styles.animate}`}>
							Є моменти, які хочеться прожити не лише вдвох... а розділити з
							тими, хто по-справжньому важливий.
							<br />
							<br />
							Для нас таким моментом стане день, коли ми пообіцяємо одне одному
							любов, підтримку і спільне життя.
						</p>
						...
						<p className={`${styles.txt} ${styles.animate}`}>
							Ми щиро хочемо, щоб саме ви були поруч, бачили наші щасливі очі,
							чули наші обіцянки і розділили з нами цей теплий, особливий день.
						</p>
					</section>
				</div>
				<img
				...
				<section className={styles.section}>
					<p className={`${styles.txt} ${styles.animate}`}>
						Ваша присутність — це найбільший подарунок для нас.
						<br />
						<br />
						З любов'ю
						<br />
						...
						<span style={{ fontSize: "2rem" }}>
							{invitation.hisName} та {invitation.herName}
						</span>
					</p>
				</section>
			</main>
