...
export default function Wedding4Client() {
	...
	const dayNumbers = getDaysOfMonth(year, month).map((d) => d.getDate());

	for (let i = 0; i < startWeekday; i++) {
		days2.push(null);
	}

	days2.push(...dayNumbers);
		...
		<>
			...
			>
				...
				>
					...
					<div style={{ width: "maxContent", margin: "0 auto" }}>
						<svg
							style={{ margin: "0 auto" }}
							width="250"
							viewBox="0 0 274 90"
						...
						/> */}
							<path
								...
								stroke="var(--bg-clr)"
								strokeWidth="2.5"
								d="M21.759 89.856C17.7483 89.856 14.079 89.088 10.751 87.552C7.42297 86.1013 4.77764 84.0533 2.81497 81.408C0.937636 78.7626 -0.00103116 75.6906 -0.00103116 72.192C-0.00103116 70.3146 0.340302 68.352 1.02297 66.304C1.96164 63.5733 3.4123 61.2266 5.37497 59.264C7.42297 57.216 9.76964 55.5946 12.415 54.4C15.743 52.864 19.0283 52.096 22.271 52.096C24.4896 52.096 25.599 52.4373 25.599 53.12C25.599 53.7173 24.8736 54.1013 23.423 54.272C17.9616 54.9546 13.7803 56.8746 10.879 60.032C8.06297 63.1893 6.65497 67.1573 6.65497 71.936C6.65497 76.6293 8.1483 80.4693 11.135 83.456C14.207 86.4426 18.1323 87.936 22.911 87.936C28.4576 87.936 33.7056 86.3146 38.655 83.072C43.6896 79.744 48.255 75.3493 52.351 69.888C56.447 64.3413 59.9883 58.1973 62.975 51.456C65.9616 44.7146 68.223 37.8453 69.759 30.848C70.6976 26.24 71.423 22.016 71.935 18.176C72.447 14.336 72.703 10.9226 72.703 7.93596C72.703 5.29063 72.447 3.9253 71.935 3.83997C71.0816 3.58396 69.4603 4.13863 67.071 5.50396C65.4496 6.35729 63.7003 7.46663 61.823 8.83196C60.031 10.1973 58.111 11.8186 56.063 13.696C54.1856 15.3173 52.3936 17.4506 50.687 20.096C48.5536 23.2533 47.487 26.0266 47.487 28.416C47.487 30.464 48.383 32.0853 50.175 33.28C52.1376 34.6453 54.015 35.328 55.807 35.328C56.575 35.328 57.471 35.1573 58.495 34.816C59.6043 34.3893 60.5003 34.176 61.183 34.176C61.951 34.176 62.335 34.3466 62.335 34.688C62.335 35.2 61.0976 35.7973 58.623 36.48C56.319 37.0773 53.887 37.376 51.327 37.376C48.767 37.376 46.5483 36.736 44.671 35.456C42.7936 34.176 41.855 32.2986 41.855 29.824C41.855 25.3013 44.799 20.4373 50.687 15.232C60.7563 6.18663 68.991 1.66396 75.391 1.66396C77.695 1.66396 79.1883 2.04796 79.871 2.81596C80.5536 3.49863 80.895 4.8213 80.895 6.78396C80.895 11.3066 79.615 18.304 77.055 27.776C74.8363 35.8826 71.8923 43.6906 68.223 51.2C64.639 58.624 60.4576 65.2373 55.679 71.04C50.9856 76.8426 45.7376 81.408 39.935 84.736C34.2176 88.1493 28.159 89.856 21.759 89.856ZM156.529 85.76C156.358 85.76 156.188 85.6746 156.017 85.504C154.908 84.1386 153.585 82.5173 152.049 80.64C150.513 78.6773 148.764 76.3733 146.801 73.728C144.326 75.1786 141.638 76.544 138.737 77.824C135.836 79.104 132.764 80.2133 129.521 81.152C122.78 83.2 116.593 84.224 110.961 84.224C104.476 84.224 99.4836 82.7306 95.985 79.744C92.8276 77.0986 91.249 73.5573 91.249 69.12C91.249 64.768 92.6996 60.2026 95.601 55.424C98.5876 50.6453 102.641 46.4213 107.761 42.752C109.894 41.3866 112.625 39.5
626 192.124 75.6906 192.124 72.192C192.124 70.3146 192.465 68.352 193.148 66.304C194.087 63.5733 195.537 61.2266 197.5 59.264C199.548 57.216 201.895 55.5946 204.54 54.4C207.868 52.864 211.153 52.096 214.396 52.096C216.615 52.096 217.724 52.4373 217.724 53.12C217.724 53.7173 216.999 54.1013 215.548 54.272C210.087 54.9546 205.905 56.8746 203.004 60.032C200.188 63.1893 198.78 67.1573 198.78 71.936C198.78 76.6293 200.273 80.4693 203.26 83.456C206.332 86.4426 210.257 87.936 215.036 87.936C220.583 87.936 225.831 86.3146 230.78 83.072C235.815 79.744 240.38 75.3493 244.476 69.888C248.572 64.3413 252.113 58.1973 255.1 51.456C258.087 44.7146 260.348 37.8453 261.884 30.848C262.823 26.24 263.548 22.016 264.06 18.176C264.572 14.336 264.828 10.9226 264.828 7.93596C264.828 5.29063 264.572 3.9253 264.06 3.83997C263.207 3.58396 261.585 4.13863 259.196 5.50396C257.575 6.35729 255.825 7.46663 253.948 8.83196C252.156 10.1973 250.236 11.8186 248.188 13.696C246.311 15.3173 244.519 17.4506 242.812 20.096C240.679 23.2533 239.612 26.0266 239.612 28.416C239.612 30.464 240.508 32.0853 242.3 33.28C244.263 34.6453 246.14 35.328 247.932 35.328C248.7 35.328 249.596 35.1573 250.62 34.816C251.729 34.3893 252.625 34.176 253.308 34.176C254.076 34.176 254.46 34.3466 254.46 34.688C254.46 35.2 253.223 35.7973 250.748 36.48C248.444 37.0773 246.012 37.376 243.452 37.376C240.892 37.376 238.673 36.736 236.796 35.456C234.919 34.176 233.98 32.2986 233.98 29.824C233.98 25.3013 236.924 20.4373 242.812 15.232C252.881 6.18663 261.116 1.66396 267.516 1.66396C269.82 1.66396 271.313 2.04796 271.996 2.81596C272.679 3.49863 273.02 4.8213 273.02 6.78396C273.02 11.3066 271.74 18.304 269.18 27.776C266.961 35.8826 264.017 43.6906 260.348 51.2C256.764 58.624 252.583 65.2373 247.804 71.04C243.111 76.8426 237.863 81.408 232.06 84.736C226.343 88.1493 220.284 89.856 213.884 89.856Z"
								// fill="black"
							/>
						</svg>
					</div>
			...
			>
							...
							return (
								<div key={i} className={styles.address}>
									...
									>
										...
										<span>Початок в {address.time}</span>
										{i < 1 && (
											<strong>
												(Час проведення церемонії може змінитись на 13:00.)
											</strong>
										)}
									</p>
									<div
									...
									{i < 1 && (
										...
										>
											Після церемонії на вас чекатиме трансфер від ЗАГСу до
											ресторану.
										</p>
									)}
								</div>
				...
				<section className={styles.section}>
					...
					<p className={`${styles.txt} ${styles.animate}`}>
						обирайте будь-які кольори, які вам подобаються, але є одне маленьке
						прохання — НЕ БІЛИЙ 🤍 Білий колір цього дня залишаємо нареченій. 👰🏻‍♀️
					</p>
					<p className={`${styles.txt} ${styles.animate}`}>
						🌿 І ще одне дуже важливе прохання: будь ласка, не даруйте нам
						квіти. Якщо дуже хочеться щось подарувати замість них — можна
						придбати сухий корм для тваринок 🐾
					</p>
					<p className={`${styles.txt} ${styles.animate}`}>
						Увесь корм ми зберемо та потім відвеземо до притулку. Тож разом
						зробимо цей день добрим не лише для нас, а й для тих, хто дуже
						потребує турботи. 🐶🐱
					</p>
				</section>
				<section className={styles.section}>
				...
				<section className={styles.section}>
					...
					>
						<img src="/wedding-4/photo.jpg" alt="" />
					</div>
					<p className={`${styles.txt} ${styles.animate}`}>
