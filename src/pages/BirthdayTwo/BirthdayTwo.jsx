...
import img1 from "/christening-boy/01.webp";
import img2 from "/christening-boy/02.webp";
import img3 from "/christening-boy/03.webp";
import img4 from "/christening-boy/04.webp";
import img5 from "/christening-boy/05.webp";
import img6 from "/christening-boy/06.webp";
import img7 from "/christening-boy/07.png";
					...
					<Container>
						<div className="home__top-chr">
							<div className="home__top-inner-chr">
								...
								<div className="home__top-date-chr">
									{date} Січня {template.time.slice(0, 4)} року
								</div>
						...
						<div className="wrapper">
							...
							<p className="pepe-chr animated-element1">
								...
								<br />
								зі щирою любов’ю запрошуємо Вас приєднатися до святкування, що
						...
						<div className="calendar-wrapper-chr animated-element1">
							<p className="calendar-top-christening">{`Січень ${template.time.slice(
								0,
								4
							)}`}</p>
