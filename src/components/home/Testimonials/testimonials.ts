...
export const testimonials: Testimonial[] = [
	...
	{
		client: "Руслан та Таїсія",
		label:
			"Хочу щиро подякувати за створення нашого весільного запрошення 💍✨ Все було зроблено дуже професійно, красиво та зі смаком. Видно, що людина вкладає душу у свою роботу та уважна до кожної деталі. Запрошення вийшло сучасне, стильне й дуже ніжне — саме таке, як ми хотіли ❤️ Окремо дякуємо за швидкий зв’язок, допомогу з усіма побажаннями та приємне спілкування. Гості були в захваті від такого формату запрошення 😊 Однозначно рекомендуємо!",
		img: "/testimonial-ruslan-and-taisiia-c.jpg",
	},
];
